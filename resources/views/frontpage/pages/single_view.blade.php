					...
					<div class="row">
								...
								<div class="property_video p0">
									<div class="thumb">
										...
										<div class="overlay_icon">
											<a href="#"><img class="map_img_icon" src="{{config('app.url')}}propsempire/images/header-logo.png" alt="header-logo.png"></a>
										</div>
									</div>
								</div>
							</div>
									  	...
									  	<div class="card floor_plan">
										    ...
										    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample" style="">
											    <div class="card-body text-center">
											    	<img class="img-fluid" src="{{config('app.url')}}propsempire/images/resource/floor_plan.png" alt="floor_plan.png">
								...
								<div class="tab-content" id="myTabContent2">
									<div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
										<div class="property_video">
											<div class="thumb">
												<img class="pro_img img-fluid w100" src="{{config('app.url')}}propsempire/images/background/7.jpg" alt="7.jpg">
												<div class="overlay_icon">
						...
						<div class="col-lg-12">
							<div class="walkscore_area mt30">
								<h4 class="mb30">Walkscore <span class="float-right"><img src="{{config('app.url')}}propsempire/images/resource/wscore.png" alt="wscore.png"></span></h4>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
					<div class="footer_contact_widget">
						<h4>Contact Us</h4>
						<ul class="list-unstyled">
							<li><a href="#"><span class="__cf_email__" data-cfemail="cca5a2aaa38caaa5a2a8a4a3b9bfa9e2afa3a1">[email&#160;protected]</span></a></li>
