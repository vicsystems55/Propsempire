                      ...
                      <div id="landCheck" class="col-md-12">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input name="bedrooms" id="bedrooms" type="text" class="touchspin" value="0" data-bts-step="1" data-bts-decimals="0">
                                </div>

                                <div class="col-md-4">
                                <label for="">Toilet</label>
                                <input id="toilets" name="toilets" type="text" class="touchspin" value="0" data-bts-step="1" data-bts-decimals="0">
                                
                                </div>

                                <div class="col-md-4">
                                <label for="">Bathrooms</label>
                                <input id="bathrooms" name="bathrooms" type="text" class="touchspin" value="0" data-bts-step="1" data-bts-decimals="0">
